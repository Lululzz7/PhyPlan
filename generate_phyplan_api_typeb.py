...
# -*- coding: utf-8 -*-
"""
TypeB 专用生成脚本（复用 generate_phyplan_api.py 的所有逻辑与 Prompt）
...
def main():
    ...
    parser = argparse.ArgumentParser(description='TypeB-only generator (QA, fields-only, live combined save).')
