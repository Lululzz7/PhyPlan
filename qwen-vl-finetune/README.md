...
# Path Configuration
# ======================
MODEL_PATH="/path/to/Qwen3-VL-8B-Instruct"  # [ModelArguments] Pretrained model path
...
The script accepts arguments in three categories:
   ...
   - Training with Qwen3-VL-32B model, you should have 8 80G GPU refering to `scripts/sft_32b.sh`
