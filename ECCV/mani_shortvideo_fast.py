# -*- coding: utf-8 -*-
"""
Parallel runner for mani_shortvideo.py
...
import mani_shortvideo as base
...
def _worker(video_path: str, output_base: str):
    # Keep config identical to original; only set output base like original main
...
def main():
    input_dir = os.environ.get("INPUT_VIDEO_DIRECTORY", "/e2e-data/embodied-research-data/luzheng/short")
